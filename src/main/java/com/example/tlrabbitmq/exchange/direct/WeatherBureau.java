...
public class WeatherBureau {
    public static void main(String[] args) throws Exception{
        ...
        channel.exchangeDeclare(RabbitConstant.EXCHANGE_WEATHER_ROUTING,"direct",true);
        ...
        while (iterator.hasNext()){
            ...
            channel.basicPublish(RabbitConstant.EXCHANGE_WEATHER_ROUTING,me.getKey(),null,me.getValue().getBytes("UTF-8"));
